...
const PoleValidationApp = () => {
  ...
  const mockPlots = [
    ...
    },
    {
      ...
      boundaries: [
        { lat: 21.148, lng: 79.0885 },
        { lat: 21.149, lng: 79.0895 },
        { lat: 21.15, lng: 79.0885 },
        { lat: 21.149, lng: 79.0875 },
      ],
      area: "3.2 acres",
      status: "active",
    },
  ...
  const mockAnalysisResults = [
    ...
    },
    {
      ...
      plotId: 2,
      poleId: "P003",
      position: { lat: 21.1485, lng: 79.089 },
      status: "warning",
      confidence: 72,
      timestamp: new Date().toISOString(),
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <header className="bg-white shadow-lg border-b md:p-2 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between py-4 sm:py-0 gap-4">
            ...
            <div className="flex items-start sm:items-center gap-3">
              ...
              <div>
                <h1 className="text-lg sm:text-xl font-bold text-gray-900">
                  AI Pole Validation System
                </h1>
                <p className="text-sm text-gray-500">
                  Geo-fenced pole placement analysis
                </p>
              </div>
            </div>
                      ...
                      {poles.map((pole) => (
                        ...
                        >
                          ...
                          <div className="flex items-center justify-between mt-2">
                            ...
                            <button
                              onClick={() =>
                                setPoles(poles.filter((p) => p.id !== pole.id))
                              }
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-blue-700">
                          Analyzing pole positions and validating placement...
                        </p>
                      </div>
                    </div>
                  </div>
                          ...
                          <div className="flex-1">
                            ...
                            <div className="grid grid-cols-3 gap-4 text-sm">
                              ...
                              <div>
                                ...
                                <p className="font-medium">
                                  {pole.aiAnalysis?.detectedObjects}
                                </p>
                              </div>
                            </div>
                          </div>
                      ...
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          <p className="text-sm text-gray-500 mb-2">
                            Position: {result.position.lat.toFixed(6)},{" "}
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-red-600">
                    {
                      analysisResults.filter((r) => r.status === "invalid")
                        .length
                    }
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold text-yellow-600">
                    {
                      analysisResults.filter((r) => r.status === "warning")
                        .length
                    }
                  </span>
                </div>
